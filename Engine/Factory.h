...
/* ------------------------------------------------
	...
	@Purpose	:
		...
		A factory class that manages all
		assets, allows the user to create
		any number of assets if the inherit
		from the Object class and the factory
		will cleanup all objects when the 
		program closes
